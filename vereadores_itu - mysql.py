...
def separa_elementos(tag):
    ...
    try:
        conn = MySQLdb.connect(host="mysql4.000webhost.com",    # your host, usually localhost
                     user="a2252074_politik",         # your username
                     passwd="teste123",  # your password
                     db="a2252074_dbvere")        # name of the data base
        cur = conn.cursor()
